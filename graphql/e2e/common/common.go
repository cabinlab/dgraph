...
func RunAll(t *testing.T) {
	...
	t.Run("query geo contains LineString", queryGeoContainsLineString)
	t.Run("query geo contains MultiPoint", queryGeoContainsMultiPoint)
	t.Run("query geo contains MultiLineString", queryGeoContainsMultiLineString)
	t.Run("query geo malformed coordinates no panic", queryGeoMalformedCoordinatesNoError)
	...
	t.Run("Geo - LineString type", mutationLineStringType)
	t.Run("Geo - MultiLineString type", mutationMultiLineStringType)
	t.Run("Geo - MultiPoint type", mutationMultiPointType)
